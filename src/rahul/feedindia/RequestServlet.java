...
public class RequestServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		Date responsibiltyTakenOn = null; // the day volunteer accepts the responsibility
		...
		request.setProperty("responsibiltyTakenOn", responsibiltyTakenOn);
		...
		try {
			...
			r.put("responsibiltyTakenOn", responsibiltyTakenOn);
