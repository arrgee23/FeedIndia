...
public class CheckoutDonationServlet extends HttpServlet{
	
	private static final long serialVersionUID = 3017296863427296635L;
		...
		if ((ukey =((Key) session.getAttribute("key"))) != null) {
			try {//TODO msg
				...
				try {
					...
					if((boolean)donation.getProperty("isHandled")){
						...
						donation.setProperty("handledOn", new Date()); // mark the responsibility taken today
						donation.setProperty("isHandled", true);
