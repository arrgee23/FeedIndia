	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if ((ukey =((Key) session.getAttribute("key"))) != null) {
			try {//TODO msg
				...
				try {
					Entity request = datastore.get(dKey);
					// check if responsibility has already been taken
					if((boolean)request.getProperty("isHandled")){
						...
						request.setProperty("handledOn", new Date()); // mark the responsibility taken today
						request.setProperty("isHandled", true);
